...
class ListOfOrdersPage:
    ...
    def get_text_of_content_title(self):
        self.get_text_of_element(Locators.CONTENT_TITLE_IN_ORDER_INFO_WINDOW)
    ...
    def get_number_of_specified_order_in_orders_list(self,order_number):
        self.get_text_of_element(Locators.order_number_in_list_of_orders_locator(order_number))
