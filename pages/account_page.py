...
class AccountPage(BasePage):
    ...
    def get_text_of_restore_password_window(self):
        self.get_text_of_element(Locators.RESTORE_PASSWORD_WINDOW_TEXT)
    ...
    def get_text_of_enter_code_from_the_letter_field(self):
        self.get_text_of_element(Locators.ENTER_CODE_FROM_THE_LETTER_FIELD)
    @allure.step('Получить текст неактивного поля "Пароль"')
    def get_text_of_inactive_password_field(self):
        self.get_text_of_element(Locators.PASSWORD_FIELD_INACTIVE)
    ...
    def get_text_of_active_password_field(self):
        self.get_text_of_element(Locators.PASSWORD_FIELD_ACTIVE)
    ...
    def get_text_of_active_orders_history_button(self):
        self.get_text_of_element(Locators.HISTORY_OF_ORDERS_ACTIVE_BUTTON)
    ...
    def get_text_of_log_in_button(self):
        self.get_text_of_element(Locators.LOG_IN_BUTTON)
    ...
    def get_number_of_last_order_in_order_history(self):
        self.get_text_of_element(Locators.LAST_ORDER_NUMBER_IN_HISTORY)
    ...
    def get_number_of_last_order_in_order_history_with_scroll(self):
        ...
        self.get_number_of_last_order_in_order_history()
